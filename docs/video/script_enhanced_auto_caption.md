...
| subtitle_style    | string  | No       | Subtitle style ('classic', 'modern', 'karaoke', 'highlight', 'underline', 'word_by_word') | 'classic' |
...
| line_color        | string  | No       | Color for subtitle text                           | null      |
| word_color        | string  | No       | Color for highlighted words                       | null      |
| outline_color     | string  | No       | Color for text outline                            | null      |
...
| x                 | number  | No       | X position for subtitles                          | null      |
| y                 | number  | No       | Y position for subtitles                          | null      |
